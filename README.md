...
│   └── processed/           # Cleaned CSVs (generated by 00_Data_Cleaning.ipynb)
        └── model_data.zip   # <--- UNZIP THIS (Contains the final training dataset)
├── notebooks/
...
│   └── 02_Feature_Engineering.ipynb            # Feature Creation: Rolling averages (Form), Career stats (Class), and Venue scoring stats.
